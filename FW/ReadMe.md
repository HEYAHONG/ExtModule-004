...
- [002-base_lowspeed](002-base_lowspeed):低速模式(采用不超过60M Hz的时钟,可能使用额外的`Code Flash`区域)的MCU模板
- [003-freertos_lowspeed](003-freertos_lowspeed):低速模式(采用不超过60M Hz的时钟,可能使用额外的`Code Flash`区域)的MCU模板(启用FreeRTOS内核)
